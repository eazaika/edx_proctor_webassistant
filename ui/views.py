...
from sso_auth.social_auth_backends import LETIteachBackend
...
class Index(View):
    ...
    def get(self, request):
        ...
        login_url = reverse('social:begin', args=(
            'letiteach-oauth2',)) if settings.SSO_ENABLED else reverse('login')
        ...
        return render(
            ...
            self.template_name,
            {
                ...
                'my_profile_url': settings.SSO_LETITEACH_URL + '/dashboard' if settings.SSO_ENABLED else '',
                ...
                'profile_url': LETIteachBackend.PROFILE_URL,
...
def logout(request, next_page=None,
    ...
    response = redirect('%s?%s=%s' % (settings.SSO_LETITEACH_URL + "/logout",
